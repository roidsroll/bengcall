@extends('layouts.admin', ['title' => 'Tambah User - bengcall'])
    ...
    <div class="mx-auto max-w-2xl">
        <div class="flex items-center justify-between">
            <div>
                ...
                <p class="mt-1 text-sm text-slate-600">Buat akun user baru.</p>
            </div>
            <a
                ...
                <div class="grid gap-4 sm:grid-cols-2">
                    ...
                    <div>
                        ...
                        <select
                            ...
                            class="mt-1 w-full rounded-xl border border-slate-200 bg-white px-3 py-2 text-slate-900 shadow-sm outline-none focus:border-[#CE2626] focus:ring-4 focus:ring-[#CE2626]/20"
                        >
                            <option value="" disabled @selected(old('gender') === null || old('gender') === '')>Pilih…</option>
