@extends('layouts.admin', ['title' => 'Tambah Service - bengcall'])

@section('content')
    <div class="mx-auto max-w-3xl">
        <div class="flex items-center justify-between">
            <div>
                <h1 class="text-2xl font-semibold tracking-tight text-slate-900">Tambah Service</h1>
                <p class="mt-1 text-sm text-slate-600">Buat service baru.</p>
            </div>
            <a
