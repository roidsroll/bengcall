@extends('layouts.admin', ['title' => 'Edit Category - bengcall'])
    ...
    <div class="mx-auto max-w-2xl">
        <div class="flex items-center justify-between">
            <div>
                ...
                <p class="mt-1 text-sm text-slate-600">Update data category.</p>
            </div>
            <a
            ...
            <div class="rounded-2xl bg-white p-6 shadow-sm ring-1 ring-slate-200">
                <div>
                    ...
                    <p class="mt-1 text-xs text-slate-500">
                        Slug saat ini: <span class="font-mono">{{ $category->slug }}</span>
                    </p>
                </div>
