@extends('layouts.admin', ['title' => 'Tambah Brand - bengcall'])

@section('content')
    <div class="mx-auto max-w-2xl">
        <div class="flex items-center justify-between">
            <div>
                <h1 class="text-2xl font-semibold tracking-tight text-slate-900">Tambah Brand</h1>
                <p class="mt-1 text-sm text-slate-600">Buat brand baru.</p>
            </div>
            <a
        ...
        <form method="POST" action="{{ route('admin.brands.store') }}" class="mt-6 space-y-4">
            @csrf
